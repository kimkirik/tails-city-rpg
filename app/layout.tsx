...
export const metadata: Metadata = {
  ...
  icons: {icon: [{url:'/icons/richi-anime-32.png',sizes:'32x32',type:'image/png'},{url:'/icons/richi-anime-192.png',sizes:'192x192',type:'image/png'}],apple:[{url:'/icons/richi-anime-180.png',sizes:'180x180',type:'image/png'}]},
